...
def cook_content(information):
    ...
    message = message + \
        ...
        "▫️ " + bold("Changelog: ", "<a href=\"https://raw.githubusercontent.com/SuperiorOS/OTA/sixteen-los/source_changelogs.txt\">Source</a>" + " | " + "<a href=\"https://raw.githubusercontent.com/SuperiorOS/OTA/changelogs/sixteen-los/sixteen_" + str(information['device']) + ".txt\"> Device</a>") + "\n" + \
        "▫️ " + bold("Flashing Method: ", "<a href=\"https://github.com/SuperiorOS/OTA/flashing_method/" + str(information['device']) + ".md\">Here</a>") + "\n" + \
